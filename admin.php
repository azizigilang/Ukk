...
if($_SESSION['level']!='admin'){
    echo"<script>
    alert('maaf bukan seorang admin');
...
<div class="container mt-5">
    ...
    <a href="admin.php" class="btn btn-primary">Administator</a>
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            if(empty($file)){
                ...
                echo"Aplikasi Pembayaran SPP digunakan untuk mempermudah dalam mencatat pembayaran siswa/siswa disekolah.";
            }else{
                include $file.'.php';
            } 
            ?>
